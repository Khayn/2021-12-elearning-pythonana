...
a = A.lower().replace('.','').replace('ulica','').replace('ul','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
b = B.lower().replace('.','').replace('ulica','').replace('ul','').title().strip().replace('3','III').replace( 'Trzeciego', 'III')

# str: expected string is 'Pana Twardowskiego III'
c = C.lower().replace('.','').replace('ulica','').replace('ul','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
d = D.lower().replace('.','').replace('ulica','').replace('ul','').replace('\n','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
e = E.lower().replace('.','').replace('ulica','').replace('ul','').replace('\n','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
f = F.lower().replace('.','').replace('ulica','').replace('ul','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
g = G.lower().replace('.','').replace('ulica','').replace('ul','').replace('\n','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
h = H.lower().replace('.','').replace('ulica','').replace('ul','').title().strip().replace('3','III').replace('Iii','III')

# str: expected string is 'Pana Twardowskiego III'
i = I.lower().replace('.','').replace('ulica','').replace('ul','').replace('\t',' ').title().strip().replace('3','III').replace('Iii','III')
