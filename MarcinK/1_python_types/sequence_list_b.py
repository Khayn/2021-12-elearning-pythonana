...
a = [float(DATA[1][0:3]), float(DATA[1][4:7]), float(DATA[1][8:11]), float(DATA[1][12:15]), DATA[1][16:25]]

# list[float|str]: with data from row[2]: 5.1, 3.5, 1.4, 0.2 and setosa
b = [float(DATA[2][0:3]), float(DATA[2][4:7]), float(DATA[2][8:11]), float(DATA[2][12:15]), DATA[2][16:22]]

# list[float|str]: with data from row[3]: 5.7, 2.8, 4.1, 1.3 and versicolor
c = [float(DATA[3][0:3]), float(DATA[3][4:7]), float(DATA[3][8:11]), float(DATA[3][12:15]), DATA[3][16:27]]
