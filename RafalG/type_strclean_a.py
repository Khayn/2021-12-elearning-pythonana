...
a = A.replace("ul", "").strip().replace("TwaRDOWSkiego", "Twardowskiego")

# str: expected string is 'Pana Twardowskiego III'
b = B.replace("\tul.","").strip().title().replace("Trzeciego", "III")

# str: expected string is 'Pana Twardowskiego III'
c = C.replace("ulicaPana", "Pana")

# str: expected string is 'Pana Twardowskiego III'
d = D.title().replace("\n","").replace("3","III")

# str: expected string is 'Pana Twardowskiego III'
e = E.replace("UL.", "").strip().replace("TWARDowsKIEGO", "Twardowskiego")

# str: expected string is 'Pana Twardowskiego III'
f = F.replace("ULICA", "").strip().replace("TWARDOWSKIEGO", "Twardowskiego")

# str: expected string is 'Pana Twardowskiego III'
g = G.replace("ULICA.", "").strip().replace("TWARDowsKIEGO", "Twardowskiego")
